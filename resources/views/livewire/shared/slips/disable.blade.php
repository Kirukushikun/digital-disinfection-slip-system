<div>
    <x-modals.modal-template show="showModal" max-width="max-w-lg">
        <x-slot name="header">
            <div class="flex items-center">
                @if ($reasonDisabled)
                    ...
                    <h3 class="ml-4 text-lg font-semibold text-gray-900">Enable Reason</h3>
                @else
                    ...
                    <h3 class="ml-4 text-lg font-semibold text-gray-900">Disable Reason</h3>
                @endif
            </div>
        </x-slot>
        ...
        <p class="text-sm text-gray-600">
            @if ($reasonDisabled)
                Are you sure you want to enable <span class="font-semibold text-gray-900">"{{ $reasonText }}"</span>? This reason will be available for selection again.
            @else
                Are you sure you want to disable <span class="font-semibold text-gray-900">"{{ $reasonText }}"</span>? This reason will not be available for selection.
            @endif
        </p>
        ...
        <x-slot name="footer">
            ...
            @if ($reasonDisabled)
                <button wire:click="toggle" wire:loading.attr="disabled" wire:target="toggle"
                    ...
                    <span wire:loading.remove wire:target="toggle">Enable Reason</span>
            ...
            @else
                <button wire:click="toggle" wire:loading.attr="disabled" wire:target="toggle"
                    ...
                    <span wire:loading.remove wire:target="toggle">Disable Reason</span>
