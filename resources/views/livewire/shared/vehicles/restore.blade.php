                ...
                <div
                    ...
                    <div class="px-6 py-4">
                        ...
                        <p class="text-sm text-gray-600">
                            Are you sure you want to restore vehicle <span class="font-semibold text-gray-900">{{ $vehicleName }}</span>? This will make the vehicle available again in the system.
                        </p>
                    </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                        ...
                        <button wire:click="restore" wire:loading.attr="disabled" wire:target="restore"
                            ...
                            <span wire:loading.remove wire:target="restore">Restore Vehicle</span>
