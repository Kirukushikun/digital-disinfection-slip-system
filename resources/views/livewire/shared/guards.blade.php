<div class="min-h-screen bg-gray-50 p-6" @if (
    !$showFilters &&
        ...
        !($config['showRestore'] && ($showRestoreModal ?? false))) wire:poll.keep-alive @endif>
    <div class="max-w-7xl mx-auto">
        ...
        {{-- Restore Confirmation Modal - Only if showRestore is enabled --}}
        @if ($config['showRestore'] && $showRestoreModal)
