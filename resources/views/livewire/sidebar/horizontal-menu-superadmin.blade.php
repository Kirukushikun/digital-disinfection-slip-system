...
<div class="flex items-center gap-2">
    {{-- Dashboard --}}
    <x-navigation.horizontal-menu-item href="{{ route('superadmin.dashboard') }}" :active="$currentRoute === 'superadmin.dashboard'"
    ...
    {{-- Audit Trail --}}
    <x-navigation.horizontal-menu-item href="{{ route('superadmin.audit-trail') }}" :active="$currentRoute === 'superadmin.audit-trail'"
        icon='<svg xmlns="https://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    {{-- Settings --}}
    <x-navigation.horizontal-menu-item href="{{ route('superadmin.settings') }}" :active="$currentRoute === 'superadmin.settings'"
        icon='<svg xmlns="https://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
