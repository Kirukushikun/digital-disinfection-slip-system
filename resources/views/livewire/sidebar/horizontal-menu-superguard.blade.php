...
@php
    ...
    $dataManagementRoutes = ['user.data.guards', 'user.data.drivers', 'user.data.locations', 'user.data.plate-numbers'];
...
<div class="flex items-center gap-2">
    ...
    <x-navigation.horizontal-menu-dropdown label="Data" :active="$isDataManagementActive"
        ...
        <x-navigation.sidebar-menu-item href="{{ route('user.data.plate-numbers') }}" :active="$currentRoute === 'user.data.plate-numbers'"
            icon='<svg xmlns="https://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
