...
<div class="space-y-1">
    {{-- Dashboard --}}
    <x-navigation.sidebar-menu-item href="{{ route('admin.dashboard') }}" :active="$currentRoute === 'admin.dashboard'"
    ...
    {{-- Trucks --}}
    <x-navigation.sidebar-menu-item href="{{ route('admin.trucks') }}" :active="$currentRoute === 'admin.trucks'"
        icon='<img src="https://cdn-icons-png.flaticon.com/512/605/605863.png" alt="Trucks" class="w-5 h-5 object-contain" />'>
        Trucks
    </x-navigation.sidebar-menu-item>

    {{-- Reports --}}
    <x-navigation.sidebar-menu-item href="{{ route('admin.reports') }}" :active="$currentRoute === 'admin.reports'"
        icon='<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    {{-- Audit Trail --}}
    <x-navigation.sidebar-menu-item href="{{ route('admin.audit-trail') }}" :active="$currentRoute === 'admin.audit-trail'"
        icon='<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
