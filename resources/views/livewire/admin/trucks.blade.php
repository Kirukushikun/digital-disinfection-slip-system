<div class="min-h-screen bg-gray-50 p-6" @if (!$showFilters && !$showCreateModal && !$showDetailsModal && !$showDeleteConfirmation && !$showRemoveAttachmentConfirmation) wire:poll.keep-alive @endif>
