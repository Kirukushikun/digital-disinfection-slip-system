                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-3xl shadow-lg border border-gray-200 p-6 lg:p-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div wire:poll class="group">
                                <div class="p-4 bg-linear-to-br from-blue-50 to-blue-100/50 rounded-2xl border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 hover:shadow-md">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-blue-700 uppercase tracking-wide mb-0.5">Week to Date</p>
                            ...
                            <!-- Month to Date -->
                            <div wire:poll class="group">
                                <div class="p-4 bg-linear-to-br from-purple-50 to-purple-100/50 rounded-2xl border-2 border-purple-200 hover:border-purple-400 transition-all duration-300 hover:shadow-md">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-purple-700 uppercase tracking-wide mb-0.5">Month to Date</p>
                            ...
                            <!-- Year to Date -->
                            <div wire:poll class="group">
                                <div class="p-4 bg-linear-to-br from-green-50 to-green-100/50 rounded-2xl border-2 border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-md">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-green-700 uppercase tracking-wide mb-0.5">Year to Date</p>
                            ...
                            <!-- All Time Total -->
                            <div wire:poll class="group">
                                <div class="p-4 bg-linear-to-br from-orange-500 to-yellow-500 rounded-2xl border-2 border-orange-400 hover:border-orange-600 transition-all duration-300 hover:shadow-lg">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-white/90 uppercase tracking-wide mb-0.5">Total Disinfected</p>
                    ...
                    <div class="bg-white rounded-3xl shadow-lg border border-gray-200 p-6 lg:p-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <!-- Guards -->
                            <div wire:poll class="group">
                                <div class="p-4 bg-linear-to-br from-cyan-50 to-cyan-100/50 rounded-2xl border-2 border-cyan-200 hover:border-cyan-400 transition-all duration-300 hover:shadow-md">
                                    <div class="flex items-center gap-3">
                                        <div class="shrink-0 p-3 bg-cyan-200 rounded-xl group-hover:bg-cyan-300 transition-colors">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-cyan-700 uppercase tracking-wide mb-0.5">Guards</p>
                                            <p class="text-3xl font-bold text-gray-900">{{ number_format($this->stats['total_guards']) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Drivers -->
                            <div wire:poll class="group">
                                <div class="p-4 bg-linear-to-br from-pink-50 to-pink-100/50 rounded-2xl border-2 border-pink-200 hover:border-pink-400 transition-all duration-300 hover:shadow-md">
                                    <div class="flex items-center gap-3">
                                        <div class="shrink-0 p-3 bg-pink-200 rounded-xl group-hover:bg-pink-300 transition-colors">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-pink-700 uppercase tracking-wide mb-0.5">Drivers</p>
                                            <p class="text-3xl font-bold text-gray-900">{{ number_format($this->stats['total_drivers']) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Trucks -->
                            <div wire:poll class="group">
                                <div class="p-4 bg-linear-to-br from-amber-50 to-amber-100/50 rounded-2xl border-2 border-amber-200 hover:border-amber-400 transition-all duration-300 hover:shadow-md">
                                    <div class="flex items-center gap-3">
                                        <div class="shrink-0 p-3 bg-amber-200 rounded-xl group-hover:bg-amber-300 transition-colors">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-amber-700 uppercase tracking-wide mb-0.5">Trucks</p>
                                            <p class="text-3xl font-bold text-gray-900">{{ number_format($this->stats['total_plate_numbers']) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Locations -->
                            <div wire:poll class="group">
                                <div class="p-4 bg-linear-to-br from-teal-50 to-teal-100/50 rounded-2xl border-2 border-teal-200 hover:border-teal-400 transition-all duration-300 hover:shadow-md">
                                    <div class="flex items-center gap-3">
                                        <div class="shrink-0 p-3 bg-teal-200 rounded-xl group-hover:bg-teal-300 transition-colors">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-teal-700 uppercase tracking-wide mb-0.5">Locations</p>
                                            <p class="text-3xl font-bold text-gray-900">{{ number_format($this->stats['total_locations']) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
