<div class="min-h-screen bg-gray-50 p-6" @if (!$showFilters) wire:poll.keep-alive @endif>
    <div class="max-w-7xl mx-auto">
        ...
        {{-- Edit Modal --}}
        <livewire:super-admin.admins.edit />

        {{-- Disable/Enable Confirmation Modal --}}
        <livewire:super-admin.admins.disable />

        {{-- Reset Password Modal --}}
        <livewire:super-admin.admins.reset-password />

        {{-- Create Admin Modal --}}
        <livewire:super-admin.admins.create />

        {{-- Delete Confirmation Modal --}}
        <livewire:super-admin.admins.delete />

        {{-- Restore Confirmation Modal --}}
        <livewire:super-admin.admins.restore />
    </div>
</div>
