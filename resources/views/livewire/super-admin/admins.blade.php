<div class="min-h-screen bg-gray-50 p-6" @if (!$showFilters && !$showCreateModal && !$showEditModal && !$showDisableModal && !$showDeleteModal && !$showResetPasswordModal && !$showRestoreModal) wire:poll.keep-alive @endif>
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6">
            ...
            @if ($filtersActive && !($showDeleted ?? false))
                    ...
                    @csrf
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                            ...
                            <button wire:click.prevent="createAdmin" wire:loading.attr="disabled" wire:target="createAdmin"
                                ...
                                <span wire:loading.remove wire:target="createAdmin">Create</span>
                                <span wire:loading.inline-flex wire:target="createAdmin" class="inline-flex items-center gap-2"><svg class="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>Creating...</span>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all w-full max-w-lg">
                        <div class="px-6 py-4 bg-white border-b border-gray-200">
                            <div class="flex items-center">
                                ...
                                <h3 class="ml-4 text-lg font-semibold text-gray-900">Delete Admin</h3>
                            </div>
                        </div>

                        <div class="px-6 py-4">
                            <p class="text-sm text-gray-600">
                                Are you sure you want to delete <span class="font-semibold text-gray-900">{{ $selectedUserName }}</span>? This action cannot be undone. The item will be permanently removed from the system.
                            </p>
                        </div>

                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                            <button wire:click="closeModal" wire:loading.attr="disabled" wire:target="deleteUser"
                            ...
                            <button wire:click="deleteUser" wire:loading.attr="disabled" wire:target="deleteUser"
                                ...
                                <span wire:loading.remove wire:target="deleteUser">Delete Admin</span>
                                <span wire:loading.inline-flex wire:target="deleteUser" class="inline-flex items-center gap-2">
                                    <svg class="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
                    ...
                    @csrf
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                            ...
                            <button wire:click.prevent="restoreUser" wire:loading.attr="disabled" wire:target="restoreUser"
                                ...
                                <span wire:loading.inline-flex wire:target="restoreUser" class="inline-flex items-center gap-2"><svg class="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>Restoring...
                                </span>
                            </button>
                        </div>
                    </div>
