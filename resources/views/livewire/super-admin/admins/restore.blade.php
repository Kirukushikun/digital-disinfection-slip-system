            ...
            <div class="flex min-h-full items-center justify-center p-4">
                <div
                    ...
                    <div class="px-6 py-4">
                        ...
                        <p class="text-sm text-gray-600">
                            Are you sure you want to restore <span
                                class="font-medium text-gray-900">{{ $userName }}</span>?
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                        ...
                        <button wire:click.prevent="restore" wire:loading.attr="disabled" wire:target="restore"
                            ...
                            <span wire:loading.remove wire:target="restore">Restore Admin</span>
