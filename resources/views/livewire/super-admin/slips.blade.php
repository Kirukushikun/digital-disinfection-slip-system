<div class="min-h-screen bg-gray-50 p-6" @if (!$showFilters && !$showDetailsModal && !$showRemoveAttachmentConfirmation && !$showCancelEditConfirmation && !$showAttachmentModal) wire:poll.keep-alive @endif>
