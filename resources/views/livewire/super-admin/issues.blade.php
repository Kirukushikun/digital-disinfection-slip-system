                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-semibold text-gray-900">
                                        @if ($issue->slip_id)
                                            ...
                                            @elseif ($issue->slip)
                                                <span class="text-gray-900 font-semibold">Slip: {{ $issue->slip->slip_id ?? $issue->slip_id }} <span class="text-gray-500 italic">(deleted)</span></span>
                                            @else
                                                <span class="text-gray-900 font-semibold">Slip: {{ $issue->slip_id }} <span class="text-gray-500 italic">(deleted)</span></span>
                                            @endif
                                        @else
                            ...
                            <div class="text-gray-900">
                                @if ($selectedIssue->slip_id)
                                    ...
                                    @elseif ($selectedIssue->slip)
                                        <span class="text-gray-900 font-semibold">Slip: {{ $selectedIssue->slip->slip_id ?? $selectedIssue->slip_id }} <span class="text-gray-500 italic">(deleted)</span></span>
                                    @else
                                        <span class="text-gray-900 font-semibold">Slip: {{ $selectedIssue->slip_id }} <span class="text-gray-500 italic">(deleted)</span></span>
                                    @endif
                                @else
                                    <span class="text-gray-500 italic">Miscellaneous</span>
                                @endif
