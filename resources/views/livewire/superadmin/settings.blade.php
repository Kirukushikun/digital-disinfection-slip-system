            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <form wire:submit.prevent="updateSettings">
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            <label for="log_retention_months" class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">
                                This logo will be used when a location doesn't have a custom logo. Supported formats:
                                JPEG,
