            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-3xl shadow-lg border border-gray-200 p-6 lg:p-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <!-- Guards -->
                            <a href="{{ route('superadmin.guards') }}" wire:poll class="group">
                                <div
                            ...
                            <!-- Admins -->
                            <a href="{{ route('superadmin.admins') }}" wire:poll class="group">
                                <div
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p
                                                ...
                                                Admins</p>
                                            <p class="text-3xl font-bold text-gray-900">
                                                {{ number_format($this->stats['total_admins']) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <!-- Drivers -->
                            <a href="{{ route('superadmin.drivers') }}" wire:poll class="group">
                                <div
                            ...
                            <!-- Locations -->
                            <a href="{{ route('superadmin.locations') }}" wire:poll class="group">
                                <div
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-3xl shadow-lg border border-gray-200 p-6 lg:p-8 lg:sticky lg:top-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('superadmin.audit-trail') }}"
                            ...
                            <a href="{{ route('superadmin.settings') }}"
                                class="group block p-4 bg-linear-to-br from-slate-50 to-slate-100/50 rounded-2xl border-2 border-slate-200 hover:border-slate-400 hover:shadow-md hover:cursor-pointer transition-all duration-300">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="p-2.5 bg-slate-200 rounded-xl group-hover:bg-slate-300 transition-colors">
                                    ...
                                    <span
                                        class="font-semibold text-gray-800 group-hover:text-slate-700 transition-colors">System
                                        Settings</span>
                                </div>
                            </a>
                        </div>
