                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    @if ($showDeleted)
                                        <x-buttons.submit-button wire:click="restoreLocation({{ $location->id }})"
                                            ...
                                            <span wire:loading.remove wire:target="restoreLocation({{ $location->id }})">
                                            ...
                                            <span wire:loading wire:target="restoreLocation({{ $location->id }})" class="inline-flex items-center gap-1.5">
