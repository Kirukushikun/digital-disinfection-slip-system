...
class Locations extends Component
{
    ...
    public function updateLocation()
    {
        ...
        $oldValues = $location->only(['location_name', 'attachment_id', 'disabled', 'create_slip']);
    ...
    public function closeModal()
    {
        ...
        $this->reset(['selectedLocationId', 'selectedLocationDisabled', 'selectedLocationName', 'location_name', 'edit_logo', 'current_logo_path', 'remove_logo', 'original_location_name', 'original_attachment_id', 'create_location_name', 'create_logo', 'create_slip', 'create_create_slip', 'original_create_slip']);
    ...
    public function render()
    {
        $query = $this->showDeleted 
            ? Location::onlyTrashed()->with('attachment')
            : Location::with('attachment')->whereNull('deleted_at');
    ...
    public function openPrintView()
    {
        ...
        $printUrl = route('superadmin.print.locations', ['token' => $token]);
